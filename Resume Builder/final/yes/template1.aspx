<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="template1.aspx.cs" EnableEventValidation ="false" Inherits="Resume_Builder.final.yes.template1" %>
    ...
    <form id="form1" runat="server">
        <div>
            ...
            <table class="auto-style1">
                ...
                <tr>
                    <td class="auto-style4">
                        <asp:Label ID="Label1" runat="server" Text="Work Experience"></asp:Label>
                    </td>
                    <td>
