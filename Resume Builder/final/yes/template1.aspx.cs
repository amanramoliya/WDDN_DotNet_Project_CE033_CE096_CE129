    ...
    public partial class template1 : System.Web.UI.Page
    {
        ...
        protected void Page_Load(object sender, EventArgs e)
        {
            ...
            if (Session["Username"] != null)
            {
                ...
                if (rs != null)
                {
                    Image1.ImageUrl = "~/images/" + rs.imagepath;
                    name.Text = rs.firstname + " " + rs.lastname;
                    email.Text = rs.email;
                    ...
                    IQueryable<skill> s2 = rb.skills.Where(l => l.username == u1);
                    foreach (skill i in s2)
                    {
                        Label lb88 = new Label();
                        lb88.ID = "sk" + i.skill1;
                        lb88.Text = i.skill1 + "  ";
                        Language.Controls.Add(lb88);
                    }
