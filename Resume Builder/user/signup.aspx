<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="signup.aspx.cs" Inherits="Resume_Builder.login" %>
    ...
    <form id="form1" runat="server">
        ...
        <div class="Outer">
            ...
            <asp:Label ID="_mobileno" runat="server" CssClass="form-inline" Text="Mobile No."></asp:Label>
                    ...
                    <asp:RequiredFieldValidator ID="password_req" runat="server" ErrorMessage="*" ForeColor="Red" ControlToValidate="password" ToolTip="Password is required"></asp:RequiredFieldValidator>
                    
                    <asp:TextBox ID="password" runat="server" CssClass="form-control form-group-lg" TextMode="Password" Width="350px"></asp:TextBox>
            ...
            <asp:Label ID="_confirmpassword" runat="server" CssClass="form-inline" Text="Confirm Password"></asp:Label>
                    ...
                    <asp:TextBox ID="confirmpassword" runat="server" CssClass="form-control form-group-lg" TextMode="Password" Width="350px"></asp:TextBox>
              
                    <asp:CompareValidator ID="confirmpassword_validate" runat="server" ControlToCompare="password" ControlToValidate="confirmpassword" ErrorMessage="Confirm password must match password" ForeColor="#FF0066" ToolTip="Password &amp; Confirm password must be same"></asp:CompareValidator>
               
                    <asp:Button ID="register" runat="server" CssClass="btn btn-default" OnClick="register_Click" Text="Register" />
                &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
                    <asp:HyperLink ID="alreadyhaveaccount" runat="server" NavigateUrl="~/user/login.aspx" CssClass="Links">Already have Account? Login</asp:HyperLink>
                </div>
        </div>
    </form>
</body>
